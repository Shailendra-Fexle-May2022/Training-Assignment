...
*
*  Revision Logs    :  	V_1.0 - Created - 09/12/2022
*
*/
...
export default class GenericTable extends NavigationMixin(LightningElement)
{
    ...
    popUpToastMessage() 
    {
        NotificationsUtilities.showToastMessageNotification(STATUS_MESSAGES.ERROR_LOWERCASE ,  UNEXPECTED_ERROR_WHILE_SAVE_MESSAGE, STATUS_MESSAGES.ERROR_LOWERCASE);
    }

    popUpAlertMessage() 
    {
        NotificationsUtilities.showAlertMessageNotification(UNEXPECTED_ERROR_WHILE_SAVE_MESSAGE);
    }

    popUpPormptMessage() 
    {
        NotificationsUtilities.showPromptMessageNotification(UNEXPECTED_ERROR_WHILE_SAVE_MESSAGE);
    }

    popUpConfirmMessage()
    {
        NotificationsUtilities.showConfirmMessageNotification(UNEXPECTED_ERROR_WHILE_SAVE_MESSAGE);
    }
...
//showAlertMessage(JSON.stringify(row));
 //showPromptMessage(this.selectedRecordsNames);